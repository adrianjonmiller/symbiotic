    ...
    _createClass(Model, [{
        ...
        value: function render(args) {
            ...
            return _utils2.default.check(frag.children, function ($children) {
                return _utils2.default.loop($children, function ($child) {
                    if (_this5.tagName === 'template') {
                        if (_this5.parent !== undefined) {
                            return _this5.parent.append($child, methods);
                        }
                    } else {
                        return _this5.append($child, methods);
                    }
                });
            });
        }
        ...
        value: function updateStyles() {
            ...
            _utils2.default.debounce(function () {
                if (!_utils2.default.check(_this6.style)) {
                    _this6.$styleNode.innerHTML = '';
                    return;
                }

                var styleString = '#' + _this6.id + '{';

                _utils2.default.loop(_this6.style, function (value, prop) {
                    styleString += _utils2.default.camelCaseToDash(prop) + ':' + value + ';';
                });

                styleString += '}';

                if (_this6.$styleNode.parentNode === null) {
                    _global2.default.head.appendChild(_this6.$styleNode);
                }

                _this6.$styleNode.innerHTML = styleString;
            })();
        }
    }, {
        key: 'plugins',
